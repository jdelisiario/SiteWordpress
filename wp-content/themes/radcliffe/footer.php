...
<div class="credits section light-padding">
	...
	<div class="credits-inner section-inner">
		...
		<p class="fright">
			...
			<span><?php _e( 'Tema do site', 'radcliffe' ); ?> <a href="http://www.andersnoren.se">Anders Nor&eacute;n</a> &mdash; </span><a title="<?php _e('Topo do site', 'radcliffe'); ?>" href="#" class="tothetop"><?php _e('Topo', 'radcliffe' ); ?> &uarr;</a>
